...
<%
List<Product> latestProducts = ProductMrg.getInstance().getLatestProducts(8);
List<Product> rproducts = ProductMrg.getInstance().getRecommendedProducts(4);
%>
					...
					<ul class="top-link list-inline">
						<li class="account" id="my_account">
							...
							<ul class="dropdown-menu ">
								...
								<li><a href="selfservice.jsp"><i class="fa fa-pencil-square-o"></i> SelfService</a></li>
							</ul>
						</li>
					...
					<ul class="tab-content content dropdown-menu pull-right shoppingcart-box" role="menu">
						...
						<li>
							<div>
								...
								<p class="text-right"> <a class="btn view-cart" href="cart.jsp"><i class="fa fa-shopping-cart"></i>View Cart</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-mega checkout-cart" href="#"><i class="fa fa-share"></i>Checkout</a> </p>
							</div>
						</li>
					</ul>
				</div>
				...
				<span class="ltabs-tab-selected">Jewelry &amp; Watches	</span> <span class="ltabs-tab-arrow">▼</span>
					<div class="item-sub-cat">
						<ul class="ltabs-tabs cf">
							<li class="ltabs-tab tab-sel" data-category-id="20" data-active-content=".items-category-20"> <span class="ltabs-tab-label">Jewelry1122 &amp; Watches						</span> </li>
			...
			<div class="ltabs-items-container">
				...
				<div class="ltabs-items ltabs-items-selected items-category-20 grid" data-total="10">
					<div class="ltabs-items-inner ltabs-slider ">
						...
						<%
						for (Iterator<Product> it = rproducts.iterator(); it.hasNext();) {
							Product rp = it.next();
							%>
						...
						<div class="ltabs-item product-layout">
							<div class="product-item-container">
								...
								<div class="right-block">
									<div class="caption">
										<h4><a href="product.html"><%= rp.getName() %></a></h4>
										<div class="ratings">
											<div class="rating-box">
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
										...
										<div class="price">
											<span class="price-new"><%= rp.getMemberPrice() %></span>
											<span class="price-old"><%= rp.getNormalPrice() %></span>
										</div>
									</div>
		...
		<div class="ltabs-wrap ">
			<div class="ltabs-tabs-container" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="#" data-type_source="0">
				...
				<span class="ltabs-tab-selected">Jewelry &amp; Watches	</span> <span class="ltabs-tab-arrow">▼</span>
					<div class="item-sub-cat">
						<ul class="ltabs-tabs cf">
							<li class="ltabs-tab tab-sel" data-category-id="1" data-active-content=".items-category-1"> <span class="ltabs-tab-label">Jewelry123 &amp; Watches						</span> </li>
					...
					<div class="ltabs-items-inner ltabs-slider ">
						...
						<div class="ltabs-item product-layout">
							<div class="product-item-container">
								...
								<div class="right-block">
									<div class="caption">
										<h4><a href="product.html">Bint Beef111</a></h4>
										<div class="ratings">
											<div class="rating-box">
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
						...
						for (Iterator<Product> it = latestProducts.iterator(); it.hasNext();) {
							...
							<div class="product-item-container">
								<div class="left-block">
									<div class="product-image-container second_img ">
										<img src="image/product/<%= p.getId() %>.jpg"  alt=<%= p.getName() %> class="img-responsive" />
										<img src="image/demo/shop/product/B9.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
									</div>
									<!--Sale Label-->
									<span class="label label-sale">Sale</span>
								...
								<div class="right-block">
									<div class="caption">
										<h4><a href="productdetailshow.jsp?id=<%= p.getId() %>"> <%= p.getName() %> </a></h4>
										<div class="ratings">
											<div class="rating-box">
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
										...
										<div class="price">
											<span class="price-new">$<%= p.getNormalPrice() %></span>
										</div>
									</div>
					...
					<div class="ltabs-items-inner ltabs-slider ">
						...
						<div class="ltabs-item product-layout">
							<div class="product-item-container">
								...
								<div class="right-block">
									<div class="caption">
										<h4><a href="product.html">Bint Beef222</a></h4>
										<div class="ratings">
											<div class="rating-box">
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
												<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
										...
										<div class="price">
											<span class="price-new">$97LAST.00</span>
										</div>
									</div>
